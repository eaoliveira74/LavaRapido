<template>
  <div id="app-root">
    ...
    <div id="a11y-toolbar" class="p-2" style="background:#f8fafc;">
      <div class="container">
        <div class="a11y-controls d-flex flex-wrap gap-2 align-items-center">
        ...
        <div class="a11y-actions d-flex flex-column gap-2 align-items-start mt-2">
          <button id="a11y-reset" class="btn btn-outline-secondary btn-sm">Restaurar padrão</button>
        </div>
      </div>
    </div>

    <!-- Botão flutuante de alternância (sempre visível) -->
    ...
    <main class="container py-4">
      ...
      <div id="client-view" class="d-none">
        <div class="d-flex justify-content-end mb-3" id="logout-slot-client">
      ...
      <div id="admin-view" class="d-none">
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="d-flex gap-2 flex-wrap" id="admin-action-buttons">
              ...
              <button id="show-water-consumption-btn" class="btn btn-outline-light">Consumo de Água</button>
            </div>
          </div>
          ...
          <div id="admin-stats-section" class="card mt-4 d-none">
            <div class="card-body">
              <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2 mb-3">
                <h3 class="card-title h5 mb-0">Estatísticas</h3>
                <div class="text-center text-md-end flex-grow-1">
                  <small class="text-secondary">O CEP é usado para dados meteorológicos.</small>
                </div>
              </div>
          ...
          <div id="admin-water-consumption-section" class="card mt-4 d-none">
            <div class="card-body">
              ...
              <div class="row g-3 mb-3 align-items-end">
                <div class="col-auto">
                  <label for="water-consumption-range" class="form-label">Período:</label>
                  <select id="water-consumption-range" class="form-select form-select-sm compact-50">
                ...
                <div class="col-auto">
                  <label for="water-consumption-date" class="form-label">Data de referência:</label>
                  <input type="date" id="water-consumption-date" class="form-control form-control-sm compact-50" />
                </div>
                <div class="col-auto">
                  <button id="water-consumption-refresh" class="btn btn-cyan">Atualizar</button>
                </div>
              </div>
              <div class="mb-2" style="min-height:320px;">
                <canvas id="water-consumption-chart"></canvas>
              </div>
              <div id="water-consumption-summary" class="small text-secondary"></div>
            </div>
          </div>
...
import { init } from './legacy/legacy-app';
...
watch(
  ...
  (role) => {
    if (typeof document !== 'undefined') {
      document.body.dataset.activeRole = role || 'selection';
    }
  },
  { immediate: true }
);
